...
SliderInner.InputBegan:Connect(function(Input)
    if (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) and not Library:MouseIsOverOpenedFrame() then
        ...
        while InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) or (InputService:IsTouchMoving(Enum.UserInputType.Touch) and not Library:MouseIsOverOpenedFrame()) do
...
return Slider
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        DropdownOuter.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch and not Library:MouseIsOverOpenedFrame() and not Library:MouseIsOverOpenedFrame() then
